---
name: gat-brainstorm
description: Develop or refine a game concept through a one-question-at-a-time design interview, then create GAT game overview, systems index, and global art direction documents; also supports discussion-only exploration. Use for game concepts, core loops, system boundaries, scope, or visual direction in a GAT project.
---
...
- `../../assets/templates/design/game-overview.md`
- `../../assets/templates/design/systems-index.md`
- `../../assets/templates/design/global-art.md`
