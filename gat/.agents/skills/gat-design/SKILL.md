---
name: gat-design
description: Design one system or all remaining systems within a specific planned GAT milestone, producing milestone-scoped GDD, optional content data, and art documents while updating progress and auditing consistency. Requires an explicit milestone.
---
...
- `../../assets/templates/design/system-gdd.md`
- `../../assets/templates/design/system-art.md`
- `../../assets/templates/design/content-data.md`
