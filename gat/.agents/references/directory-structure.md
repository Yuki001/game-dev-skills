...
The `.agents/` directory is self-contained and can be copied into a project root. Skills resolve their packaged references and templates relative to their own `SKILL.md` files.
...
6. `.agents/` defines how the GAT agent team produces the pre-production docs.
