...
6. Create each milestone's directory `gat/milestone/m{N}-<name>/` and author its `m{N}-brief.md` skeleton (template: `../../assets/templates/plan/m-brief.md`) with all systems marked Pending and status `planned`.
