...
This package defines a portable Codex workflow for game pre-production.
...
- Use `.agents/assets/templates/design/*` and `.agents/assets/templates/plan/*` as the canonical scaffolds
...
- [Workflow Catalog](workflow-catalog.yaml)
