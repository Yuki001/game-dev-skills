...
- Images:
  - `chess-midgame.png` — Chess mid-game original

  - `edit-chess-winter.png` — Chess mid-game restyled as winter scene
...
- Image: `tea-poster-metro-lightbox.png`

- Input image: `tea-poster.png`
