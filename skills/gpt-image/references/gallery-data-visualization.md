...
- Image: `small-multiples-climate-grid.png`
...
- Image: `network-graph-collaboration-map.png`
...
- Image: `chord-diagram-energy-flows.png`
...
- Image: `treemap-startup-budget-allocation.png`
...
- Image: `geographic-choropleth-harvest-yield.png`
