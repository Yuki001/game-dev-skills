...
- What does success require players to do for, with, or against one another?
- Do individual rewards align with team or community goals?
- Can one player obtain value by making another player's experience worse?

### Cooperation

- Do roles create complementary contributions without making one player subordinate or idle?
...
- Which mechanics allow obstruction, hostage-taking, stalking, collusion, fraud, or unwanted communication?
- How quickly can a targeted player exit, mute, block, report, or recover?
- Do enforcement signals protect reporters without teaching offenders how to evade detection?

### Spectator clarity

- Can an observer identify goals, momentum changes, risk, and exceptional decisions?
- Does spectator information compromise competitive integrity or player privacy?
...
- expression systems provide prestige mainly through scarcity or harassment targets.

## Small experiments

- Model how each reward changes behavior when team interests and personal interests diverge.
